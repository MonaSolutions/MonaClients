...
:: Android packaging
set AND_CERT_NAME="MobilePublisher"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MobilePublisher.p12
...
set IOS_PROVISION=cert\MobilePublisher.mobileprovision
